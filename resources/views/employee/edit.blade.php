                ...
                <div class="card-body employee-detail-edit-body">
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            {!! Form::text('name', null, ['class' => 'form-control','required' => 'required',\Auth::user()->type != 'super admin'?"readonly":""]) !!}
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {!! Form::text('last_name', null, ['class' => 'form-control','required' => 'required',\Auth::user()->type != 'super admin'?"readonly":""]) !!}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('email',null, ['class' => 'form-control',\Auth::user()->type != 'super admin'?"readonly":""]) !!}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::text('old_employee_code', null, ['id'=>'old_employee_code', 'class' => 'form-control',\Auth::user()->type != 'super admin'?"readonly":""]) !!}
                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('employee_code', __('New Employee Code'),['class'=>'form-control-label']) !!}
                                {!! Form::text('employee_code', null, ['id'=>'employee_code', 'class' => 'form-control',\Auth::user()->type != 'super admin'?"readonly":""]) !!}
                            </div>
