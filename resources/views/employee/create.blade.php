            ...
            <div class="card-body ">
                <div class="row">
                    <div class="form-group col-md-4">
                        {!! Form::label('name', __('First Name'),['class'=>'form-control-label']) !!}<span
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::number('employee_alternate_contact',old('employee_alternate_contact'), ['class' =>
                        'form-control']) !!}
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="float-right col-8">
                        ...
                        <div class="choose-file form-group">
                            <label for="document">
                                ...
                                <input class="form-control border-0" required name="employee_photo" type="file"
            ...
            <div class="card-body employee-detail-create-body">
                ...
                <div class="row">
                    <div class="form-group col-md-8">
                        ...
                        {!! Form::text('document['.$document->id.'][description]', "", ['id'=>'description', 'class' =>
                        'form-control']) !!}
                    </div>
                    <div class="form-group col-md-4 mt-4 p-2">
                        ...
                        <div class="choose-file form-group">
                            <label for="document[{{ $document->id }}]">
                                ...
                                name="document[{{$document->id}}][file]"
                                type="file" id="document[{{ $document->id }}]
