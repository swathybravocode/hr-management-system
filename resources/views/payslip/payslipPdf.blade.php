@php $logo=asset(Storage::url('uploads/logo/')); $company_logo=Utility::getValByName('company_logo'); @endphp @extends('layouts.admin')
<style>
    address {
        text-align: justify;
    }
...
@section('page-title') {{__('Payslip')}} @endsection @section('content')
