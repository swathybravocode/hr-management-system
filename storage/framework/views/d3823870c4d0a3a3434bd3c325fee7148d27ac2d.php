    ...
    <div class="row">
        <?php if(\Auth::user()->type !='company'): ?>
            <div class="form-group col-md-6 col-lg-6 ">
                ...
                <?php echo e(Form::select('complaint_from', $current_employee,null, array('class' => 'form-control  select2','required'=>'required'))); ?>
...
<?php /**PATH /home/eysysco/public_html/hrms_demo/EysysHRM/resources/views/complaint/create.blade.php ENDPATH**/ ?>