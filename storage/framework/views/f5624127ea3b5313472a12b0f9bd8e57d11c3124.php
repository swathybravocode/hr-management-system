            ...
            <ul class="navbar-nav navbar-nav-docs">
                ...
                <?php if(Gate::check('Manage Employee')): ?>
                    <?php if(\Auth::user()->type =='employee'): ?>
                        ...
                        ?>
                        <li class="nav-item <?php echo e(request()->is('employee*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('employee.show',\Illuminate\Support\Facades\Crypt::encrypt($employee->id))); ?>" class="nav-link">
                                <i class="fas fa-users"></i><?php echo e(__('Employee')); ?>

                            </a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item <?php echo e((Request::route()->getName() == 'employee.index') ||  (Request::route()->getName() == 'employee.create') ||  (Request::route()->getName() == 'employee.edit') ||  (Request::route()->getName() == 'employee.show') ? 'active' : ''); ?>">
...
<?php /**PATH /home/thefutu4/public_html/client_demo/HRM_Code/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>