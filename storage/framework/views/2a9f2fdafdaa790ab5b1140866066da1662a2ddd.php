            ...
            <div class="col-lg-3 col-sm-6 col-md-6">
                <div class="card profile-card">
                    ...
                    <div class="avatar-parent-child">
                        <img src="<?php echo e((!empty($users->avatar)? $profile.'/'.$users->avatar : $profile.'/avatar.png')); ?>" class="avatar rounded-circle avatar-xl">
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eysysco/public_html/hrms_demo/EysysHRM/resources/views/user/index.blade.php ENDPATH**/ ?>