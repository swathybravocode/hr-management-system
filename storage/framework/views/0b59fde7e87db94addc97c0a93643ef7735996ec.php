                ...
                <div class="card-body py-0">
                    <div class="table-responsive">
                        <table class="table table-striped mb-0 dataTable" >
                            <thead>
                            <tr>
                                <?php if(auth()->check() && auth()->user()->hasRole('hr')): ?>
                            ...
                            <?php $__currentLoopData = $resignations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resignation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <div class="badge badge-pill badge-warning"><?php echo e($resignation->status); ?></div>
                                    <?php elseif($resignation->status=="Approved"): ?>
                                    <div class="badge badge-pill badge-success"><?php echo e($resignation->status); ?></div>
                                    <?php else: ?>
                                    <div class="badge badge-pill badge-danger"><?php echo e($resignation->status); ?></div>
                                    <?php endif; ?>
                                    </td>
                                    ...
                                    <?php if(Gate::check('Edit Resignation') || Gate::check('Delete Resignation')): ?>
                                        <td>
                                            <?php if(auth()->check() && auth()->user()->hasRole('hr')): ?>
                                            <a href="#" data-url="<?php echo e(URL::to('resignation/'.$resignation->id.'/action')); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Resign Action')); ?>" class="edit-icon bg-success" data-toggle="tooltip" data-original-title="<?php echo e(__('Resign Action')); ?>"><i class="fas fa-caret-right"></i> </a>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eysysco/public_html/hrms_demo/EysysHRM/resources/views/resignation/index.blade.php ENDPATH**/ ?>