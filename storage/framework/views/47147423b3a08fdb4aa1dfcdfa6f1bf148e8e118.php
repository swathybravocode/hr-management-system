<div class="card bg-none card-box">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('full_loan_amount', __('Loan Amount'),['class'=>'form-control-label'])); ?>

            <?php echo e(Form::number('full_loan_amount',null, array('class' => 'form-control ','required'=>'required','step'=>'0.01'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('amount', __('Loan Deduction Amount'),['class'=>'form-control-label'])); ?>
...
<?php /**PATH /home/eysysco/public_html/hrms_demo/EysysHRM/resources/views/loan/create.blade.php ENDPATH**/ ?>