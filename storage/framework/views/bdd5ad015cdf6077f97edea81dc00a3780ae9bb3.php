                    ...
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php echo Form::text('head_quarter', null, ['id'=>'head_quarter', 'class' => 'form-control']); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body employee-detail-edit-body">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo Form::text('pan_card_number', null, ['class' => 'form-control']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eysysco/public_html/hrms_demo/EysysHRM/resources/views/employee/edit.blade.php ENDPATH**/ ?>