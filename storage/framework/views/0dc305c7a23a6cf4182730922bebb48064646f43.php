...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        var options = {
            ...
            yaxis: {
                title: {
                    text: "<?php echo e(\App\Utility::getValByName('site_currency_symbol')); ?> "
                }
            },
            fill: {
                opacity: 1
            ...
            tooltip: {
                y: {
                    formatter: function (val) {
                        return "<?php echo e(\App\Utility::getValByName('site_currency_symbol')); ?> " + val
                    }
                }
            },
            legend: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\EysysHRM_Code\resources\views/report/income_expense.blade.php ENDPATH**/ ?>